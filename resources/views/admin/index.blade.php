...
@section('src-header-admin')
    <!-- Timeline CSS -->
    <link href="{{$urlPublicAdmin}}css/timeline.css" rel="stylesheet">
    <!-- Morris Charts CSS -->
    <link href="{{$urlPublicAdmin}}css/morris.css" rel="stylesheet">
@endsection
{{--content--}}
...
@section('src-footer-admin')
    ...
    <script src="{{$urlPublicAdmin}}js/raphael.min.js"></script>
    <script src="{{$urlPublicAdmin}}js/morris.min.js"></script>
    <script src="{{$urlPublicAdmin}}js/morris-data.js"></script>
@endsection
