                ...
                @foreach( $arIndex['randomPro'] as $random)
                    ...
                    <div class="ads-product-content">
                        <div class="ads-product-img">
                            ...
                            @endphp
                            <img src="{{$urlStorage}}storage/app/products/{{$img_rand}}" alt="">
                        </div>
                    </div>
                            ...
                            <div class="new-product-content">
                                <div class="product-new-content">
                                    @php
                                        ...
                                        $linkImg = reset($img);
                                    @endphp
                                    <img src="{{$urlStorage}}storage/app/products/{{$linkImg}}" alt="">
                                </div>
                            </div>
                            <div class="info">
                        ...
                        @foreach( $arIndex['product_selling'] as $selling )
                            ...
                            <div class="new-product-content">
                                <div class="product-new-content">
                                    ...
                                    @endphp
                                    <img src="{{$urlStorage}}storage/app/products/{{$img_selling}}" alt="">
                                </div>
                            </div>
                            <div class="info">
                            ...
                            <div class=" box-product-new item">
                                <div class="new-product-content">
                                    <div class="product-new-content">
                                        ...
                                        @endphp
                                        <img src="{{$urlStorage}}storage/app/products/{{$img_newpd}}" alt="">
                                    </div>
                                </div>
                                <div class="info">
                                    <p>{{$selling->name_product}}</p>
                        ...
                        <div class="new-product-content">
                            <div class="product-new-content">
                                @php
                                    ...
                                    $img = reset($images);
                                @endphp
                                <img src="{{$urlStorage}}storage/app/products/{{$img}}" alt="">
                            </div>
                        </div>
                        <div class="info">
