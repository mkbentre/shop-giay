...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="{{$urlPublicShoes}}css/style.css">
    <link rel="stylesheet" href="{{$urlPublicShoes}}css/responsive.css">
    <!-- font -->
...
<div id="wrapper">
    <header>
                ...
                <div class="header-menu-logo container">
                    ...
                    <div class="bar-header-logo">
                        <a href="{{route('shoes.shoes.index')}}">
                            <img id="nav-logo-img" src="{{$urlStorage}}storage/file/logo-mona.png" alt="">
                        </a>
                    </div>
        ...
        <script src="{{$urlPublicShoes}}js/ajax.login.js"></script>
        {{--form modal login--}}
